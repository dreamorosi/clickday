...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<? echo base_url('assets/css/jquery.fullPage.css'); ?>">
	<link rel="stylesheet" type="text/css" href="<? echo base_url('assets/css/style1.css'); ?>">
	<link rel="stylesheet" type="text/css" href="<? echo base_url('assets/css/checkbox.awesome.css'); ?>">
	<link rel="stylesheet" type="text/css" href="<? echo base_url('assets/css/animate.min.css'); ?>">
	...
	<script> window.base_url = '<? echo base_url(); ?>'; </script>

	<!-- COOKIE BAR -->
	<script type="text/javascript">
		window.cookieconsent_options = {"message":"Questo sito utilizza cookie. Per saperne di più, accedi alla","dismiss":"Accetto","learnMore":"Cookie Policy","link":'<? echo base_url('assets/Privacy_Policy_CLICKDAYATS_2017.pdf'); ?>',"theme":"dark-bottom"};
	</script>
