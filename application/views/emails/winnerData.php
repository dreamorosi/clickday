								...
								<tr>
									<td class="wrapper last">
										<table class="twelve columns">
											<tr>
												<td class="text-pad">
													<h6 style="border-bottom: 1px solid #f6a723" class="text-ora">Un utente vincitore ha compilato il proprio profilo</h6>
												</td>
												<td class="expander"></td>
											</tr>
										</table>
								...
								<tr>
									<td class="wrapper last">
										<table class="twelve columns">
											<tr>
												<td class="text-pad">
													<h6 style="font-family: 'Montserrat', Arial;" class="text-ora">Salve,</h6></br>
													<p>L'utente vincitore <? echo $name; ?> ha inserito le proprie informazioni di pagamento e il proprio comune di residenza.</p>
