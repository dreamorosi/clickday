								...
								<tr>
									<td class="wrapper last">
										<table class="twelve columns">
											<tr>
												<td class="text-pad">
													<h2 style="border-bottom: 1px solid #f6a723" class="text-ora">Attiva il Tuo Profilo</h2>
												</td>
								...
								<tr>
									<td class="wrapper last">
										<table class="twelve columns">
											<tr>
												<td class="text-pad">
													<a class="text-ora" style="text-decoration: underline" href="<? echo $code; ?>"><h6 style="font-family: 'Montserrat', sans-serif;" class="text-ora">Attiva Profilo</h6></a>
												</td>
												<td class="expander"></td>
											</tr>
										</table>
