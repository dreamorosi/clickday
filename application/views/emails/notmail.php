								...
								<tr>
									<td class="wrapper">
										<table class="six columns">
											<tr>
												<td class="left-text-pad"><img src="<? echo $base_url; ?>assets/img/logo_mail.png"/></td>
									...
									<td class="wrapper last">
										<table class="six columns">
											<tr>
												<td class="right-text-pad"><img src="<? echo $base_url; ?>assets/img/atsLogoEmail_mail.png"/></td>
												<td class="expander"></td>
											</tr>
										</table>
									</td>
								...
								<tr>
									<td class="wrapper last">
										<table class="twelve columns">
											<tr>
												<td class="text-pad">
													<h6 style="border-bottom: 1px solid #f6a723" class="text-ora">Nuovo messaggio ricevuto da <? echo $mitt;?></h6>
												</td>
												<td class="expander"></td>
											</tr>
										</table>
								...
								<tr>
									<td class="wrapper last">
										<table class="twelve columns">
											<tr>
												<td class="text-pad">
													<h6 style="font-family: 'Montserrat', Arial;" class="text-ora"><? echo $oggetto;?></h6>
													<p><? echo $testo;?></p>
												</td>
												<td class="expander"></td>
											</tr>
											<tr>
												<br><br>
												<td class="text-pad">
													<a class="text-ora" style="text-decoration: underline" href="<? echo $base_url. 'dashboard/notify/'. $email;?>"><h6 style="font-family: 'Montserrat', Arial;" class="text-ora">Clicca qui per rispondere</h6></a>
												</td>
												<td class="expander"></td>
											</tr>
										</table>
								...
								<tr>
									<td class="wrapper last">
										<table class="twelve columns">
											<tr>
												<td class="text-pad">
													<p>NON rispondere a questa mail direttamente, ma seguire il link e accedere alla dashboard.</p>
													...
													<a style="color: #000000" href="https://www.facebook.com/clickday"><img src="<? echo $base_url; ?>assets/img/facebook_circle_mail.png"/ style="display: inline-block; width: 35px; heigh: auto"><p style="margin-top: 18px">    Ehi, vediamoci anche su facebook! Hai messo mi piace alla nostra pagina?</a></p>
												</td>
												<td class="expander"></td>
											</tr>
										</table>
